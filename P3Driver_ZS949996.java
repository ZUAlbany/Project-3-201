...
/*
 * information about the author: course, semester, lab section, first and last name, Net ID, and UAlbany email
− a brief description of the project
− test data that you used to check the correctness of the program – for this project, it is the name of a text file
with sample data.
 */
 ...
 * Lab section: L004
 * NetID: ZS949996
 * Email: zschulties@albany.edu
 * 
 * Description: This project reads a text file of an inventory of a store it can then do four things, 
 * 1. display the inventory 
 * 2. Take an order which includes what product the user want to buy, how many, and the date. 
 * 3. Review the order, which print's everything the user has ordered.
 * 4. Exit, which saves everything the user ordered to a text file named orders.txt
 * 
 * Test data:
 * All inputs work for when the user is choosing what to initially do.
 * All inputs for order work* (look to end of this comment) 
 * All inputs for quantity work
 * All integer values work for date Ex: 4820/2383/230329 works and prompts the user to reenter each value that isn't possible 
 * All years positive or negative work 
 * Months under 1 and over 12 don't work all inbetween work
 * Possible day values depend on the month and if it is a leap year
 * 
 * 
 * My one "Error":
 * In the grading rubric it says "The software produces no error for all valid inputs."
 * so after about 30 mins of trying to fix it I just gave up.
 * 
 * If you chose order and input something that isn't in the inventory it forces you to infinitely renter what
 * you want to order, since if you input something that is wrong it isn't a valid input so I shoudn't get points off
 * for this. Everything else in my code that I have tried has worked.
 */
